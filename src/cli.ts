...
import { canonicalDirectory, isAllowedCwd, loadConfig, type BridgeConfig } from "./config.js";
import { AgentRouter } from "./agent-router.js";
import { readPendingBlockingInjection } from "./objective-injection.js";
import { applyPackageEnvDefaults, buildCliHomeStatus, formatCliHome, resolveIduRegistryPath } from "./cli-home.js";
import { formatProjectStateResetResult, resetProjectState, resolveProjectStatePaths, type ProjectStateResetResult } from "./project-state.js";
import {
...
import { formatOrchestratorAdvisory, formatRoleEngineStatus, type RoleEngineStatusReport } from "./cli-role-engine.js";
...
import { configureIduSessionStore, getIduSessionStatus } from "./idu-session.js";
import { formatIduPrepareResult, type IduPrepareResult } from "./idu-prepare.js";
import { runIduBootstrap } from "./idu-bootstrap.js";
import {
	migrateHygieneLayout,
	type MigrationResult,
} from "./hygiene-migrate.js";
import { approveMasterPlan, ensureMasterPlanForIdu, formatIduSupervisorPlanReport, formatMasterPlanOperation, formatMasterPlanReview, formatMasterPlanStatus, getMasterPlanStatus, handleMasterPlanNaturalDecision, readGitHead, redraftMasterPlan, rejectMasterPlan, reviewMasterPlan, type MasterPlanDraftResult, type MasterPlanProgressEvent, type MasterPlanReview, type MasterPlanStatusResult } from "./master-plan.js";
...
import { formatProjectConnectionReport, type ProjectConnectionReport } from "./project-connection.js";
import { formatProjectPostflightReport, type ProjectPostflightReport } from "./project-postflight.js";
import { formatProjectPreflightReport, type ProjectPreflightReport } from "./project-preflight.js";
import {
	getActiveProject,
	loadRegistry,
	type ProjectEntry,
...
import { maybeRunSupervisorAfterPostflight, maybeRunSupervisorAfterSemanticTrigger, maybeRunSupervisorOnIduActivation, type IduSupervisorHookResult } from "./idu-supervisor-hooks.js";
import {
...
import { formatStructuredTaskQueueDetail, StructuredTaskQueue, type StructuredTask } from "./structured-task-queue.js";
import { type TaskTemplateKind } from "./task-templates.js";
import { existsSync, readFileSync } from "node:fs";
import { join } from "node:path";
import { applySupervisorModelAssignment, loadModelAssignments, type IduModelRoleId } from "./model-assignments.js";
import { buildIduUsageReport, filterRecentIduUsageEvents, readIduUsageEvents, recordIduUsageEventDeferred } from "./usage-events.js";
import {
...
import { buildSupervisorSelfMaintenanceAdvisory, SELF_MAINTENANCE_PRESSURE_WINDOW_MS } from "./supervisor-self-maintenance-advisory.js";
...
import { ok, fail, helpText, parseHygieneMigrateArgs, formatHygieneMigrateResult, formatHygieneSweepResult } from "./cli/dispatch-glue/index.js";
...
import { handleSetupCommand, handleProjectCommand, inspectConnection, formatCliSupervisorStartupSection, formatDashboard, buildPreflightReport, buildPostflightReport, runPrepare } from "./cli/setup/index.js";
// (PR 2 imports already exist above; this is just an anchor for the editor)
import { runCliExecutionDirectorTick, formatExecutionDirectorTick, formatProposalOutbox, formatProposalDetail } from "./cli/master-plan/index.js";
